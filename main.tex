...
% Increasing safety and security of systems supervising industrial equipment in tunnels, traffic systems, and water supply systems.
...
% goal
To increase flexibility Roadster installations, the framework
shall be extended with the abilities to run on multiple autonomous machines. Furthermore, to
provide a highly available service, pairs of identical machines shall be able to
operate in a redundant setup. This ensures a continious service delivery in case one of
the machines fails. The communication between such machines shall be secured through the use
of encryption. Interoperability with client systems interacting with
such a redundant setup shall be guaranteed.
...
State is replicated across machines through secure network communications.
Rendundant machines operate in an active/passive setup while ensuring
