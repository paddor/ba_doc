...
Due to Roadster's software architecture which cleanly separates different concerns, code that actually depended
on the ffi-rzmq library directly was located in a single file. The following
