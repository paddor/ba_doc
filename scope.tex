...
A typical configuration contains declarations for the following:
\begin{itemize}
...
% TODO show a typical DIM tree

\begin{itemize}
	\item The current value of a \emph{variable} or \emph{aggreage}, stored in an \sh{Roadster::Domain::Model::DataItem} instance
...
% TokyoCabinet, serverless KV store, similar to SQLite
% TODO estimated sizes PD, ~300MiB, should keep for 13 months
