...
involved similar technologies, he did not hestiate to join this bachelor thesis
...
These are interacted with over numerous proprietary and standardized protocols,
for which Roadster provides specialized adapters.
...
with arrows attached to the actors represent the \zmq sockets which are used
...
all the classes instantiated to constitute the DIM. They are all defined within the
