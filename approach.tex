...
The following is a list of things that are missing before the requirements can
be fulfilled:
\begin{itemize}
\item it has to work across a hierarchical federation of nodes
\item it has to be able to handle HA clusters within the federation
\end{itemize}
...
(e.g. \rb{@owner}) to the object representing its owner node, which is part of
