...
%-----------------------------------------------------------------------------
% TODO: Preface? We need a place to explain paragraph titles using an example.
%-----------------------------------------------------------------------------
% TOC, LOF, LOT, LOL
...
\chapter{Personal development environment}
% TODO Patrik: personal dev env
% * Tmux in Linux in VBox on macOS
% * Tmux tabs ("windows"):
%   - first tab (development and specs):
%     - NeoVim with tabs and windows
%   - second tab: Guard for live unit tests whenever a file changes
%   - third tab (log analyzation):
%     - left pane: Roadster root node instance
%     - right pane: Roadster subnode instance
%     - third, small pane: shell to kill -9 all Roadster instances if needed

% TODO Manuel: personal dev env
%  - development: RubyMine on Windows
%  - execution: mounted in Linux VM
...
% TODO: get signature from prof again to fix HSR logo
