...
This is formally specified in \autoref{lst:feature:federation:dimsync}
\lstinputlisting[style=customgherkin, caption={Formal DIM synchronization feature}, label={lst:feature:federation:dimsync}]{listings/features/federation/dim_synchronization.feature}
