...
\hypersetup{
	unicode=true,
	pdftitle={Task Description of Bachelor Thesis "Roadster"},
	pdfsubject={Porting and HA extension of Roadster},
...
\maketitle
\fancyhead[EL,OL]{\includegraphics[trim=10 10 10 10, clip=true, width=0.3\textwidth]{img/hsr_logo.pdf}}
