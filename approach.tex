...
\begin{description}
	...
	\item [Jnettop:]\hfill\\
		...
		network connections between the nodes. % FIXME: sure? I think it's only for viewing.
	\item [Fake:]\hfill\\
...
have been added.
% FIXME: Maybe we should stick to the 5 use cases
\begin{description}
...
Persistence synchronization is tested for all scenarios. % TODO: persistence is NOT part of NFRs
