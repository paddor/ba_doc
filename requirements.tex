...
\lstinputlisting[style=customgherkin, caption={Formal message routing feature}, label={lst:feature:federation:cmdrouting}]{listings/features/federation/message_routing.feature}
