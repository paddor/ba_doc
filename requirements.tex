...
% FIXME: exotic is too colloquial
...
\begin{figure}[]
	...
	\caption{Exotic Federation example: Multi level, \gls{HA} at bottom}
...
\begin{figure}[]
	...
	\caption{Exotic Federation example: Multi level, \gls{HA} in the middle}
