...
design custom message flows and to achieve reliability with respect to the
failure types in question, if needed.  The
...
support\footnote{such as Ruby's Marsharalling support:
