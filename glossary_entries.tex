...
\newglossaryentry{zmq}{
	name={\zmq},
	description={High-performance socket library and concurrency framework for advanced messaging},
	sort={0MQ}
}
...
\newglossaryentry{nacl}{
	name={NaCl},
	description={Networking and Cryptography Library. Modern, state-of-the-art cryptography library, created by the Daniel J. Bernstein. \url{https://nacl.cr.yp.to}}
}

\newglossaryentry{tweetnacl}{
	name={TweetNaCl},
	description={A compact, portable reimplementation of the NaCl in the
...
\url{http://tweetnacl.cr.yp.to}}
}
\newglossaryentry{libsodium}{
	name={libsodium},
	description={A portable and installable variant of \gls{nacl}. \url{https://libsodium.org}}
}
...
\newglossaryentry{isa95}{
	name={ISA-95},
	description={An international standard for developing an automated interface between enterprise and control systems. \url{https://en.wikipedia.org/wiki/ANSI/ISA-95}}
}
