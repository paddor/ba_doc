...
\lstinputlisting[style=customgherkin, caption={Formal message routing feature}, label={lst:feature:federation:cmdrouting}]{listings/features/federation/command_routing.feature} % FIXME rename file
