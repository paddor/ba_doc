...
The typical topology setups include:

\begin{description}
	\item [ Single level, single node ] \hfill\\
		This is the legacy setup and is what Roadster is already able
		to do. Consisting of only one node, it's not actually a cluster.
		% TODO: illustration

	\item [ Multi level, without \gls{HA} ] \hfill\\
...
\begin{figure}[]
	\center
	\includegraphics[width=0.6\textwidth]{img/cluster_example.pdf}
