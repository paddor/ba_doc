...
part of the federation functionality. This means replicating updates to DIM entities
to all other actors on the node (legacy behavior) and on all other nodes.
...
Instances of these entity classes are marked "dirty" when modified, but not
synchronized yet.
